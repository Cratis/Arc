...
public class with_postgresql : given.a_migration_builder
{
    MigrationBuilder _migrationBuilder;
    AddColumnOperation _result;

    void Establish() => _migrationBuilder = CreatePostgreSqlMigrationBuilder();
    ...
    [Fact] void should_set_type_to_text() => _result.ColumnType.ShouldEqual("TEXT");
