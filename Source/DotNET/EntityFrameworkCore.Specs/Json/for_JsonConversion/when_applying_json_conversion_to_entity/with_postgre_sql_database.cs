...
public class with_postgre_sql_database : given.a_json_conversion_context
{
    ...
    [Fact] void should_set_address_column_type_to_jsonb() => _addressProperty.GetColumnType().ShouldEqual("jsonb");
