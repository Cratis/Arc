...
public class and_composing_a_context_free_single : a_composed_observation
{
    ...
    void Because()
    {
        ...
        var auxiliary = _dbContext.AuxiliaryEntities.ObserveSingle(entity => entity.Name == _target.Name, ignoreQueryContext: true);
    ...
    [Fact] void should_find_the_entity_despite_the_requested_second_page() => _observed.Id.ShouldEqual(_target.Id);
