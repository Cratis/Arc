...
public class with_same_path_different_types : Specification
{
    ...
    [
        new ImportStatement(typeof(string), "TypeZ", "./models/types"),
        new ImportStatement(typeof(string), "TypeA", "./models/types"),
        new ImportStatement(typeof(string), "TypeM", "./models/types")
    ];
