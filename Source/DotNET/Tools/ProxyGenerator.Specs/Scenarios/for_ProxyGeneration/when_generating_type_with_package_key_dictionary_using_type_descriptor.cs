...
/// <summary>
/// A dictionary whose key is a package-mapped type (here Guid) generates a `ValueMap&lt;Guid, ...&gt;` and must import
/// both `ValueMap` and the key type, otherwise the generated code references an undeclared `Guid`.
/// </summary>
public class when_generating_type_with_package_key_dictionary_using_type_descriptor : Specification, IDisposable
{
    ...
    void Establish()
    {
        ...
        _descriptor = typeof(TypeWithPackageKeyDictionaryProperty).ToTypeDescriptor(string.Empty, 0);
    }
    ...
    [Fact] void should_import_the_value_map() => _generatedCode.ShouldContain("import { ValueMap } from '@cratis/fundamentals'");
