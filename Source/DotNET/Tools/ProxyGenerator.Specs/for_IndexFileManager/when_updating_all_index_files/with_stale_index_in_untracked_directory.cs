...
public class with_stale_index_in_untracked_directory : Specification
{
    ...
    /// <summary>The untracked index was not generated by the tool, so it must be left alone.</summary>
    [Fact] void should_not_remove_non_generated_untracked_index() => File.Exists(_untrackedIndexPath).ShouldBeTrue();
