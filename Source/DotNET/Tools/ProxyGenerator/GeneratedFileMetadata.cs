...
/// <param name="WasWritten">Whether the file was actually written during this generation run.</param>
public record GeneratedFileMetadata(string SourceTypeName, DateTime GeneratedTime, string ContentHash = "", bool WasWritten = false)
{
    ...
    public static bool TryParse(string firstLine, out GeneratedFileMetadata? metadata)
    {
        ...
        try
        {
            ...
            {
                metadata = new GeneratedFileMetadata(sourceName, time, hash, false);
                return true;
            }
        }
        catch
