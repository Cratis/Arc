...
/// <summary>
/// Specs for the Observe extension method detecting external UPDATE operations via SqlDependency.
/// </summary>
...
public class and_external_update_occurs(SqlServerFixture fixture) : a_sql_server_observe_context(fixture)
{
    ...
    void Because()
    {
        ...
        // Simulate external process updating data directly in SQL Server
