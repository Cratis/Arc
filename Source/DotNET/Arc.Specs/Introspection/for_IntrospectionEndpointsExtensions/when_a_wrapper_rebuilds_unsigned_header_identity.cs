...
public class when_a_wrapper_rebuilds_unsigned_header_identity : Specification
{
    ...
    async Task Because()
    {
        ...
        builder.Services.AddAuthentication("Clean")
            ...
            .AddScheme<AuthenticationSchemeOptions, given.normalizing_wrapper_handler>("Wrapper", _ => { })
            .AddScheme<AuthenticationSchemeOptions, Identity.MicrosoftIDentityPlatformAuthHandler>("Headers", _ => { });
        builder.Services.AddAuthorization();
        builder.AddCratisArc();
        await using var app = builder.Build();
        var group = app.MapGroup("/group").RequireAuthorization(new AuthorizeAttribute { AuthenticationSchemes = "Wrapper" });
