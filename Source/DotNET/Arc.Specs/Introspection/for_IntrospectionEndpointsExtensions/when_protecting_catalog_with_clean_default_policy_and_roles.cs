...
public class when_protecting_catalog_with_clean_default_policy_and_roles : Specification
{
    Exception? _failure;
    ...
    void Because() => _failure = given.catalog_guard.Map(builder =>
    {
        ...
        builder.Services.AddAuthorizationBuilder().SetDefaultPolicy(new AuthorizationPolicyBuilder("Clean").RequireAuthenticatedUser().Build());
    },
    "Administrator");
