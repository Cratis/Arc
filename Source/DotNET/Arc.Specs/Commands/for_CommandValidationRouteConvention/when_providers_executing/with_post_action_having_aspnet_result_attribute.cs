...
public class with_post_action_having_aspnet_result_attribute : given.a_command_validation_route_convention
{
    ...
    void Establish()
    {
        ...
        _action = new ActionModel(method, [new HttpPostAttribute(), new AspNetResultAttribute()]);

        var selector = new SelectorModel
        {
            AttributeRouteModel = new AttributeRouteModel
            {
                Template = "api/execute"
            }
        };
