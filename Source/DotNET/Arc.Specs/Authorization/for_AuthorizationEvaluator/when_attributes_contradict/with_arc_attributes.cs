...
public class with_arc_attributes : given.both_attribute_families
{
    Exception _arcFirst;
    ...
    void Because()
    {
        _arcFirst = Catch.Exception(() => ArcFirst().IsAuthorized(typeof(ContradictingWithArc)));
        _aspNetFirst = Catch.Exception(() => AspNetFirst().IsAuthorized(typeof(ContradictingWithArc)));
    }
