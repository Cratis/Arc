...
public class and_the_append_is_in_a_field_initializer : Specification
{
    Exception _result;
...
namespace TestNamespace
{
    ...
    {
        readonly Func<AuthorRegistered, Task> _append =
            @event => {|#0:eventStore.EventLog|}.Append(""some-author"", @event);

        public Task On(AuthorRegistered @event) => _append(@event);
    }
}",
