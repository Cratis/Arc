...
public class and_reactor_appends_many_transactionally_through_event_store_event_log : Specification
{
    Exception _result;
...
namespace TestNamespace
{
    ...
    public class AuthorNotifier(IEventStore eventStore) : IReactor
    {
        public Task On(AuthorRegistered @event) =>
            {|#0:eventStore.EventLog|}.Transactional.AppendMany(""some-author"", new object[] { @event });
    }
}",
