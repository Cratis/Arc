...
public class and_reactor_routes_to_a_named_sequence_through_event_store : Specification
{
    Exception _result;
...
namespace TestNamespace
{
    ...
    public class AuthorNotifier(IEventStore eventStore) : IReactor
    {
        public Task On(AuthorRegistered @event) =>
            eventStore.GetEventSequence(new EventSequenceId(""audit"")).Append(""some-author"", @event);
    }
}"));
