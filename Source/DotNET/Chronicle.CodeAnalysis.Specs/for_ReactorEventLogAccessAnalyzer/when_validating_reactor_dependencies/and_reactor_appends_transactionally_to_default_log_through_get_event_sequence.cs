...
public class and_reactor_appends_transactionally_to_default_log_through_get_event_sequence : Specification
{
    Exception _result;
...
namespace TestNamespace
{
    ...
    public class AuthorNotifier(IEventStore eventStore) : IReactor
    {
        public Task On(AuthorRegistered @event) =>
            {|#0:eventStore.GetEventSequence(EventSequenceId.Log)|}.Transactional.Append(""some-author"", @event);
    }
}",
