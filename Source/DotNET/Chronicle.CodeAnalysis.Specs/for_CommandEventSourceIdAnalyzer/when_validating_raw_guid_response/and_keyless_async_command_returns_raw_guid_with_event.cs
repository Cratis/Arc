...
public class and_keyless_async_command_returns_raw_guid_with_event : Specification
{
    Exception _result;
...
namespace TestNamespace
{
    ...
    {
        public {|#0:Task<(Guid, ExpenseSubmitted)>|} Handle() =>
            Task.FromResult((Guid.NewGuid(), new ExpenseSubmitted(Amount)));
    }
}",
