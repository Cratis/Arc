...
public class and_keyless_command_returns_raw_guid_before_event : Specification
{
    Exception _result;
...
namespace TestNamespace
{
    ...
    {
        public {|#0:(Guid, ExpenseSubmitted)|} Handle() => (Guid.NewGuid(), new ExpenseSubmitted(Amount));
    }
}",
