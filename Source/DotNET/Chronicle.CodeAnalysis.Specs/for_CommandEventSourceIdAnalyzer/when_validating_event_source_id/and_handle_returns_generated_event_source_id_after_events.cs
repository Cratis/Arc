...
public class and_handle_returns_generated_event_source_id_after_events : Specification
{
    Exception _result;
...
namespace TestNamespace
{
    ...
    {
        public (IEnumerable<object>, AuthorId) Handle() => (new object[] { new AuthorRegistered(""John"") }, new AuthorId(Guid.NewGuid()));
    }
}"));
