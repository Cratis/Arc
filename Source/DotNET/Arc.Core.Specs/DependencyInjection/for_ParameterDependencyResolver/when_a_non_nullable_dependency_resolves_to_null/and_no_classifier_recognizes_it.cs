...
public class and_no_classifier_recognizes_it : Specification
{
    ...
    void Establish()
    {
        ...
        _serviceProvider = new ServiceCollection()
            .AddSingleton<IInstancesOf<IUnresolvableDependencyClassifier>>(
                new KnownInstancesOf<IUnresolvableDependencyClassifier>([new DecliningClassifier()]))
    ...
    class DecliningClassifier : IUnresolvableDependencyClassifier
    {
