...
public class and_validating : given.a_command_pipeline_and_a_handler_for_command
{
    ...
    [Fact] void should_not_invoke_handler() => _commandHandler.DidNotReceive().Handle(Arg.Any<CommandContext>());
