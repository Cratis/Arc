...
public class and_nullable_parameter_resolves_to_null : given.a_command_handler_argument_resolver
{
    class Dependency;
    ...
    [Fact] void should_resolve_null_for_the_parameter() => _result.Arguments[0].ShouldBeNull();
}
