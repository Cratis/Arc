...
public class with_multiple_handlers_and_first_returns_anonymous_and_second_authenticates : given.an_authentication_system
{
    ...
    void Establish()
    {
        ...
        _secondHandler.HandleAuthentication(_context).Returns(AuthenticationResult.Succeeded(_principal));
    ...
    [Fact] void should_return_principal_from_second_handler() => _result.Principal.ShouldEqual(_principal);
