...
public class and_host_is_a_bracketed_literal_below_the_base_domain : given.a_subdomain_tenant_id_resolver
{
    string _result;

    void Establish() => _context.Host.Returns($"[::1].{BaseDomain}");
