...
/// <summary>
/// <see cref="ArcApplicationBuilder"/> is built on <see cref="Host.CreateApplicationBuilder(string[])"/>, which turns
/// both <see cref="ServiceProviderOptions.ValidateOnBuild"/> and <see cref="ServiceProviderOptions.ValidateScopes"/>
/// on in Development. Arc supplies registrations contextually that eager validation cannot construct, so an
/// Arc application could not start at all in Development. Turning that off must leave the scope check standing.
/// </summary>
