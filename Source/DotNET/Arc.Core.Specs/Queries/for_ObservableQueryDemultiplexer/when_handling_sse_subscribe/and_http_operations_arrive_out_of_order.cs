...
public class and_http_operations_arrive_out_of_order : given.a_guarded_sse_connection
{
    int _performCount;
    ...
    [Fact] void should_answer_all_idempotent_posts_successfully() => _subscribeStatusCodes[FirstQueryId].ShouldEqual(200);
}
