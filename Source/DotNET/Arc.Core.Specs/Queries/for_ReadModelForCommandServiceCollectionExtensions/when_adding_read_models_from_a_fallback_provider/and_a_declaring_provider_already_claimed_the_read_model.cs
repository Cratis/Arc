...
public class and_a_declaring_provider_already_claimed_the_read_model : Specification
{
    ...
    [Fact] void should_leave_the_read_model_with_the_declaring_provider() => _resolved.ShouldEqual(_fromDeclaringProvider);
