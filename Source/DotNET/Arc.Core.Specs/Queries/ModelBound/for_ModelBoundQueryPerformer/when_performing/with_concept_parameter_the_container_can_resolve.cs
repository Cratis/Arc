...
public class with_concept_parameter_the_container_can_resolve : given.a_model_bound_query_performer
{
    ...
    {
        public static Rate ReceivedRate { get; set; } = Rate.NotSet;
    ...
    void Establish()
    {
        // A concept is a concrete reference type, so self-binding makes the container answer true for it. The
        // argument must still be bound from the request rather than resolved as a service.
