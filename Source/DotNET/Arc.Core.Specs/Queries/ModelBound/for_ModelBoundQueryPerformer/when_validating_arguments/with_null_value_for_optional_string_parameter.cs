...
public class with_null_value_for_optional_string_parameter : given.a_model_bound_query_performer
{
    public record TestReadModel
    {
        public static string ReceivedValue { get; set; } = string.Empty;

        public static TestReadModel Query(string optionalString = "default")
        {
            ReceivedValue = optionalString;
    ...
    [Fact] void should_use_default_value() => TestReadModel.ReceivedValue.ShouldEqual("default");
}
