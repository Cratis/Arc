...
public class with_null_value_for_nullable_reference_type : given.a_model_bound_query_performer
{
    public record TestReadModel
    {
        public static string? ReceivedValue { get; set; }

        public static TestReadModel Query(string? nullableString)
        {
            ReceivedValue = nullableString;
    ...
    [Fact] void should_accept_null_value() => TestReadModel.ReceivedValue.ShouldBeNull();
}
