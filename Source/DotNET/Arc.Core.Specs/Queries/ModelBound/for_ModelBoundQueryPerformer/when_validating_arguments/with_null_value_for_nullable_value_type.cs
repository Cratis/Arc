...
public class with_null_value_for_nullable_value_type : given.a_model_bound_query_performer
{
    public record TestReadModel
    {
        public static int? ReceivedValue { get; set; }

        public static TestReadModel Query(int? nullableInt)
        {
            ReceivedValue = nullableInt;
