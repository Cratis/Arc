...
public class when_checking_should_handle_as_sse_with_json_accept_header : given.an_observable_query_handler
{
    ...
    void Establish()
    {
        ...
        _context.Headers.Returns(new Dictionary<string, string> { { "Accept", "application/json" } });
    }
