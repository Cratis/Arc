...
public class with_lowercase_cookie_in_vary : given.an_http_listener_request_context
{
    ...
    async Task Establish()
    {
        ...
        _listenerContext.Response.Headers["Vary"] = "Origin, cookie";
    }

    void Because() => _requestContext.SetNoStoreResponseHeaders();

    [Fact] void should_not_add_cookie_to_the_response_again() => _listenerContext.Response.Headers["Vary"].ShouldEqual("Origin, cookie");
}
