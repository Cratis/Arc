...
public class with_multiple_middlewares_first_handles : given.an_http_request_pipeline
{
    ...
    void Establish()
    {
        _firstMiddleware = new TestMiddleware(true);
    ...
    [Fact] void should_not_call_second_middleware() => _secondMiddleware.WasCalled.ShouldBeFalse();
