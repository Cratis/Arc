...
public class with_registered_route : given.a_well_known_routes_middleware
{
    bool _handlerCalled;
    bool _nextCalled;
    bool _result;
    ...
    async Task Because()
    {
        ...
        var responseTask = _client.GetAsync($"http://localhost:{_port}/api/test");
    ...
    [Fact] void should_call_handler() => _handlerCalled.ShouldBeTrue();
