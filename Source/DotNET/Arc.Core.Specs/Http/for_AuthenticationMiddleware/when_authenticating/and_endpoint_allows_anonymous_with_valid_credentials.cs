...
public class and_endpoint_allows_anonymous_with_valid_credentials : given.an_authentication_middleware
{
    bool _result;
    ...
    [Fact] void should_set_user_principal_on_context() => _httpRequestContext.User.ShouldEqual(_principal);
