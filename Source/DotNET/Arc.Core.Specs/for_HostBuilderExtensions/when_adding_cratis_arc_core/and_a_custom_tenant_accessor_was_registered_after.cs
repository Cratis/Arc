...
public class and_a_custom_tenant_accessor_was_registered_after : Specification
{
    ...
    [Fact] void should_resolve_the_last_registered_accessor() => ReferenceEquals(_custom, _effective).ShouldBeTrue();
