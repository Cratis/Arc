...
/// <summary>
/// Verifies that two observers on different PostgreSQL schemas are fully isolated:
/// an external insert into schema_a fires only the schema_a observer,
/// leaving the schema_b observer unaffected (separate LISTEN/NOTIFY channels).
/// </summary>
/// <param name="fixture">The PostgreSQL fixture.</param>
[Collection(PostgreSqlCollection.Name)]
public class and_two_schemas_are_segregated(PostgreSqlFixture fixture) : a_postgresql_schema_observe_context(fixture)
{
