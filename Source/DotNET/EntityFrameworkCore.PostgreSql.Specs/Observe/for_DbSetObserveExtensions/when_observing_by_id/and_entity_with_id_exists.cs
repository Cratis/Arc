...
namespace Cratis.Arc.EntityFrameworkCore.PostgreSql.Observe.for_DbSetObserveExtensions.when_observing_by_id;
...
public class and_entity_with_id_exists(PostgreSqlFixture fixture) : a_postgresql_observe_context(fixture)
{
