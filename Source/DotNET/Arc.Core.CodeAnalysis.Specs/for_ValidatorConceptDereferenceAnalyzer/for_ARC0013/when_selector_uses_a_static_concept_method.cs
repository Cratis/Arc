...
public class when_selector_uses_a_static_concept_method
{
...
namespace TestNamespace
{
    ...
    {
        public static AuthorName Create() => new(""Unknown"");
    }
    ...
    public class AuthorValidator : AbstractValidator<Author>
    {
        ...
        {
            RuleFor(c => TestNamespace.AuthorName.Create().Value).NotEmpty();
        }
    }
}");
}
