...
public class when_provide_parameter_is_non_nullable_projection_read_model
{
...
namespace TestNamespace
{
    ...
    {
        public bool Provide({|#0:Customer customer|}) => true;
        public void Handle(bool canAssign) { }
    }
    ...
    public class CustomerProjection : IProjectionFor<Customer> { }
        ...
        VerifyCS.Diagnostic("ARC0006")
            ...
            .WithLocation(0)
            .WithArguments("Customer", "AssignContact.Provide"));
}
