...
/// resolved to an unspecified id rather than rejected.
/// </remarks>
[Singleton]
public class RequiredConceptFilter : ICommandFilter
{
    ...
    {
        var missingProperties = MissingRequiredConcepts(context.Command).ToArray();
    ...
    static IEnumerable<string> MissingRequiredConcepts(object command)
    {
        ...
        return command.GetType()
            ...
            .Where(property =>
                ...
                property.GetValue(command) is null)
