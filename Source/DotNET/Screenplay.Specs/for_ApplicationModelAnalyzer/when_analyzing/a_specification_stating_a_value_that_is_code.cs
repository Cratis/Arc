...
public class a_specification_stating_a_value_that_is_code : Specification
{
    ...
    const string Scenario = """
        ...
        public class and_the_age_is_worked_out_at_run_time
        {
            readonly CommandScenario<RegisterAuthor> _scenario = new();
            readonly int _age = DateTime.UtcNow.Year - 1775;
            Result _result = null!;
    ...
    [
        ...
        ("Library/Authors/Registration/when_registering/and_the_age_is_worked_out_at_run_time.cs", Scenario),
