...
/// <summary>
/// Defines a system for running registered <see cref="IInterceptReadModel{TReadModel}"/> instances against a read model item.
/// </summary>
public interface IReadModelInterceptors
{
    /// <summary>
    /// Applies all registered interceptors for the given read model type to a single item.
    /// </summary>
