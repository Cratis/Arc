...
/// <summary>
/// Contains metadata for a discovered Query endpoint, including route information and associated documentation.
/// </summary>
...
public record QueryDiscoveryMetadata(string Name, string Namespace, string Route, string Type, string DocumentationSummary);