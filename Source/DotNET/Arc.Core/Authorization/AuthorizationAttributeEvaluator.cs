...
/// <summary>
/// Represents an implementation of <see cref="IAuthorizationAttributeEvaluator"/> that checks for the Cratis Arc <see cref="AuthorizeAttribute"/>.
/// </summary>
public class AuthorizationAttributeEvaluator : IAuthorizationAttributeEvaluator
{
    /// <inheritdoc/>
