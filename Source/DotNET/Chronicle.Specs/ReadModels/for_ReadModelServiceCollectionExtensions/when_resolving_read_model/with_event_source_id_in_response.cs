...
public class with_event_source_id_in_response : given.a_read_model_resolution
{
    void Establish()
    {
        GivenEventSourceIdInResponse();
    ...
    [Fact] void should_get_the_read_model_for_the_event_source_id_from_response() => HasGotReadModelFor(_eventSourceId).ShouldBeTrue();
}
