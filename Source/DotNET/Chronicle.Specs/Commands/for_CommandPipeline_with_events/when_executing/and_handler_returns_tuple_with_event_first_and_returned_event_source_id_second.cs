...
public class and_handler_returns_tuple_with_event_first_and_returned_event_source_id_second : given.a_command_pipeline_with_event_handlers_and_command
{
    CommandResult<ReturnedEventSourceId> _result;
    (TestEvent, ReturnedEventSourceId) _tuple;

    void Establish()
    {
        _tuple = (new TestEvent("Test"), new(Guid.NewGuid()));
    ...
    [Fact] void should_return_event_source_id() => _result.Response.ShouldEqual(_tuple.Item2);
