...
public class an_events_for_event_source_id_command_response_value_handler : Specification
{
    protected EventsForEventSourceIdCommandResponseValueHandler _handler;
