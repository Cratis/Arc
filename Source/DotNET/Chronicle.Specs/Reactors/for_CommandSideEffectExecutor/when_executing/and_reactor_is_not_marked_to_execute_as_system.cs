...
public class and_reactor_is_not_marked_to_execute_as_system : given.a_command_side_effect_executor
{
    ...
    async Task Because() => await _executor.Execute([_command], typeof(TestReactor));
