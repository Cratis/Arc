...
public class and_composing_a_context_free_single : given.a_composed_observation
{
    ...
    async Task Because()
    {
        ...
        var secondary = _auxiliary.ObserveSingle(document => document.Name == _target.Name, ignoreQueryContext: true);
    ...
    [Fact] void should_find_the_single_document_despite_the_requested_second_page() => _first.ShouldEqual(_target);
