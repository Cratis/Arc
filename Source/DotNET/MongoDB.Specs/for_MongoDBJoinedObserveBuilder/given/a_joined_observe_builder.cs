...
namespace Cratis.Arc.MongoDB.for_MongoDBJoinedObserveBuilder.given;
...
public class a_joined_observe_builder : Specification
{
    ...
    protected IMongoDBJoinedObserveBuilder<DocumentA, DocumentB> _builder;
    ...
    void Establish()
    {
        ...
        _builder = new MongoDBJoinedObserveBuilder<DocumentA, DocumentB>(
            _collection1,
            null,
            _collection2,
            null,
