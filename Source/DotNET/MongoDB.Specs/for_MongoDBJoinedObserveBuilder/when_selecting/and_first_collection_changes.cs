...
public class and_first_collection_changes : given.a_joined_observe_builder
{
    ...
    async Task Because()
    {
        ...
        _databaseChanges.OnNext(CreateChangeForCollection(DatabaseName, Collection1Name));
