...
describe('when the connection changes while a subscribe request is in flight and the stale request is rejected', given(a_server_sent_event_hub_connection, context => {
    const queryId = 'q1';
