...
describe(
    'when disposing the hub connection',
    given(a_server_sent_event_hub_connection, (context) => {
        ...
        it('should cancel the reconnect policy', () =>
            (context.policy.cancel as sinon.SinonStub).called.should.equal(true));
        it('should report zero active subscriptions', () =>
