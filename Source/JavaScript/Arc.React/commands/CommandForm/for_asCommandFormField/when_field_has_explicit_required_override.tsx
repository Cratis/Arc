...
describe('when field has explicit required override', () => {
    describe('and overriding nullable property to required', () => {
    ...
    describe('and overriding non-nullable property to not required', () => {
        let requiredAttribute: string | null = null;
