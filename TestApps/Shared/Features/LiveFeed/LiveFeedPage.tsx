...
import { All, ByAuthor } from './LiveFeed';
 ...
 *
 * Shows three panels:
 *  - All messages (subscribes to LiveFeed.All)
 *  - Messages filtered by author (subscribes to LiveFeed.ByAuthor)
        ...
        <div>
            ...
            <section style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 24 }}>
                <div>
                    ...
                    <p>Subscribes to <code>LiveFeed.All()</code>.</p>
                ...
                <div>
                    ...
                    <p>Subscribes to <code>LiveFeed.ByAuthor(author)</code> when author is set.</p>
                    <input
