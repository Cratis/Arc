...
That's the library slice — built full-stack and type-safe over a database, with a clear, low-cost path to event sourcing the day you need it. You have the model; go build your own.
