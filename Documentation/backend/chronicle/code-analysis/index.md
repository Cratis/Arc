...
| [ARCCHR0004](ARCCHR0004.md) | [EventType] repeats the type name as its id                            | Warning  | An [EventType] id equals the type name, or is empty, which changes nothing about what the event type resolves to.                                                       |
...
| [ARCCHR0006](ARCCHR0006.md) | Reactor handler invoking ICommandPipeline.Execute does not say what replay should do | Warning  | A reactor handler calls ICommandPipeline.Execute without a [OnceOnly] or [Replay] decision for what replay should do.                                     |
