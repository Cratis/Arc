...
This slice writes straight to MongoDB. Arc is persistence-agnostic — the same shape works over [EF Core](/arc/backend/entity-framework/getting-started/). If a future slice needs history, audit, and replay, the [Chronicle integration](/arc/backend/chronicle/add-event-sourcing/) can move the write side to events without touching your query or your frontend.
</Aside>
