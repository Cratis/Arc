...
The string is an ordinary response, not an event. See [Provide data to a command handler](../../../scenarios/provide-data-to-a-command.mdx) for dependency-backed examples and short-circuit behavior.
