...
The project is configured but its domain types are not defined yet. Continue to [Your first command and query](/arc/backend/csharp/getting-started/your-first-command/), choose the same database branch, then build and run. That page gives the observable success checkpoint before you add React.
