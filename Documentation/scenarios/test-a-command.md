...
For protected commands, set up the principal explicitly and assert `ShouldNotBeAuthorized()` separately from validation. The [scenario reference](/arc/backend/csharp/testing/command-scenario/) covers context setup and the complete assertion API.
