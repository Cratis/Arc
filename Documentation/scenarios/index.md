...
|---|---|
| [Validate a command](./validate-a-command.md) | Reject malformed or duplicate input before it ever becomes an event |
...
| [React to an event](./react-to-an-event.md) | Something should happen automatically when an event is appended |
