...
3. Run `dotnet run` and confirm the application starts. Continue with [standalone setup](/arc/backend/getting-started/) for database configuration, generated proxies, and the first command/query checkpoint.
</Steps>
