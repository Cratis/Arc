...
[Commands](./commands/index.mdx) and [Queries](./queries/index.md); the rest of the pages here refine
...
| ------- | ----------- |
| [Commands](./commands/index.mdx) | The `.use()` hook — instantiate, bind, validate, and execute a command from a component. |
