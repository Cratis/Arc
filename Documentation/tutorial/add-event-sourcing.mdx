...
The reassuring part: adopting it is a **write-side change**. Your queries, your generated proxies, and your React screens don't move. Let's prove it on the very first slice.
